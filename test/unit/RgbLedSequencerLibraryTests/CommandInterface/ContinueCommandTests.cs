// <copyright file="ContinueCommandTests.cs" company="natsnudasoft">
...
namespace RgbLedSequencerLibraryTests.CommandInterface
{
    ...
    public sealed class ContinueCommandTests
    {
        private static readonly Type SutType = typeof(ContinueCommand);
