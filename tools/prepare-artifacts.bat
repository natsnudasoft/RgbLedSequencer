...
robocopy "%~dp0..\src\RgbLedSequencerLibrary\bin\Release" artifact\RgbLedSequencerLibrary *.dll *.xml *.pdb example-app.config /XF *.dll.CodeAnalysisLog.xml /NDL /NJH /NJS /NP /NS /NC
