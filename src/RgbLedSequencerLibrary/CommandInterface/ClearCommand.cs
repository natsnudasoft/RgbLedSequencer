// <copyright file="ClearCommand.cs" company="natsnudasoft">
...
namespace RgbLedSequencerLibrary.CommandInterface
{
    ...
    /// <summary>
    /// Encapsulates a command that instructs the RGB LED Sequencer to clear all sequence data.
    /// </summary>
    /// <seealso cref="RgbLedSequencerCommand" />
    public sealed class ClearCommand : RgbLedSequencerCommand
    {
        /// <summary>
...
#pragma warning disable MEN010 // Avoid magic numbers
            ...
            await this.RgbLedSequencer.SendInstructionAsync(SendInstruction.ClearSequences)
