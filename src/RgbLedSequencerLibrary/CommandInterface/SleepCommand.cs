// <copyright file="SleepCommand.cs" company="natsnudasoft">
...
namespace RgbLedSequencerLibrary.CommandInterface
{
    ...
    /// <summary>
    /// Encapsulates a command that instructs the RGB LED Sequencer to go into sleep mode.
    /// </summary>
    /// <seealso cref="RgbLedSequencerCommand" />
    public sealed class SleepCommand : RgbLedSequencerCommand
    {
        /// <summary>
...
#pragma warning disable MEN010 // Avoid magic numbers
            ...
            await this.RgbLedSequencer.SendInstructionAsync(SendInstruction.Sleep)
